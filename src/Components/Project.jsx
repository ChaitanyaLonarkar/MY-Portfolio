  ...
  return (
    <>
      <section className="sectionProjects">
        <div className="marq">
          <marquee onMouseOver={(e)=>{e.target.stop()}} onMouseOut={(e)=>{e.target.start()}}>Showcasing Showcasing Showcasing Showcasing Showcasing Showcasing Showcasing Showcasing Showcasing Showcasing</marquee>
        </div>
